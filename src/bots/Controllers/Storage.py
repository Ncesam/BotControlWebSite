...
answers_storage = {
    r"{first_name}, получено: {item} от игрока {owner_item}": "Положить {item} - 1 штук",
    r"{first_name}, взять {item}": "Заклинание В",
    r"{first_name}": "Все хотят быть человеком пауком, но никто не хочет быть Питером Паркером."
}
